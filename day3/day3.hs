...
main =
  do
    ...
    let solution1 = solution rows Slope {right = 3, down = 1}
    let solution2 =
          product
            [ solution rows Slope {right = 1, down = 1},
              solution1,
              solution rows Slope {right = 5, down = 1},
              solution rows Slope {right = 7, down = 1},
              solution rows Slope {right = 1, down = 2}
            ]
